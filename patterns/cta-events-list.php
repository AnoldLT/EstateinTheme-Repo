...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group alignwide">
		<!-- wp:heading -->
		<h2 class="wp-block-heading"><?php esc_html_e( 'Upcoming events', 'estatein' ); ?></h2>
		<!-- /wp:heading -->
		...
		<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--70)">
			...
			<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)">
				...
				<div class="wp-block-group">
					<!-- wp:heading {"level":3} -->
					<h3 class="wp-block-heading"><?php esc_html_e( 'Tell your story', 'estatein' ); ?></h3>
					<!-- /wp:heading -->

					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'Atlanta, GA, USA', 'estatein' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
				...
				<div class="wp-block-group">
					...
					<p style="text-transform:uppercase"><?php echo esc_html_x( 'Mon, Jan 1', 'Example event date in pattern.', 'estatein' ); ?></p>
					<!-- /wp:paragraph -->

					<!-- wp:buttons -->
					<div class="wp-block-buttons">
						<!-- wp:button {"fontSize":"small"} -->
						<div class="wp-block-button has-custom-font-size has-small-font-size"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Buy Tickets', 'estatein' ); ?></a></div>
						<!-- /wp:button -->
					</div>
					<!-- /wp:buttons -->
				</div>
			...
			<div class="wp-block-group" style="border-top-color:var(--wp--preset--color--accent-6);border-top-width:1px;padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)"><!-- wp:group {"layout":{"type":"constrained"}} -->
				<div class="wp-block-group">
					...
					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'Mexico City, Mexico', 'estatein' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			...
			<div class="wp-block-group" style="border-top-color:var(--wp--preset--color--accent-6);border-top-width:1px;padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)"><!-- wp:group {"layout":{"type":"constrained"}} -->
				<div class="wp-block-group">
					...
					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'Thornville, OH, USA', 'estatein' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
