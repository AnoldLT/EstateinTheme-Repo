 ...
 * Slug: estatein/grid-with-categories
 * Categories: banner
 * Viewport width: 1400
...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group">
			...
			<h2 class="wp-block-heading has-x-large-font-size"><?php esc_html_e( 'Top Categories', 'estatein' ); ?></h2>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-group">
			...
			<p class="has-text-align-center"><?php esc_html_e( 'Anthuriums', 'estatein' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		<!-- wp:group {"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
		<div class="wp-block-group">
			...
			<!-- /wp:cover -->
			<!-- wp:paragraph {"align":"center"} -->
			<p class="has-text-align-center"><?php esc_html_e( 'Cactus', 'estatein' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		<!-- wp:group {"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
		<div class="wp-block-group">
			...
			<!-- /wp:cover -->
			<!-- wp:paragraph {"align":"center"} -->
			<p class="has-text-align-center"><?php esc_html_e( 'Sunflowers', 'estatein' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
	</div>
